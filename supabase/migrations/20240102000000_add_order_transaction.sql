...
BEGIN
  ...
  IF p_amount < v_market_record.min_amount OR p_amount > v_market_record.max_amount THEN
    RAISE EXCEPTION 'Amount must be between % and %', 
      v_market_record.min_amount, 
      v_market_record.max_amount;
  END IF;
