      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[1, 2, 3, 4].map((i) => (
            <div
              key={i}
              className="h-[260px] bg-[#0A0F1C] rounded-2xl p-6 animate-pulse"
            >
                ...
                >
                  ...
                  <div className="relative h-full p-6 flex flex-col">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      ...
                      {market.isHot && (
                        <div className="flex items-center gap-1.5 bg-white/5 backdrop-blur-sm px-2 py-1 rounded-full ring-1 ring-white/10">
                          <span
                            className={`w-1 h-1 rounded-full ${theme.dot} animate-pulse`}
                          />
                    ...
                    <div className="space-y-3 mb-6">
                      <h3
                        className={`text-lg font-semibold text-white/90 ${theme.text} transition-colors duration-300 line-clamp-2 min-h-[3.5rem]`}
                      >
                        {market.title}
                      </h3>
